...
@property (nonatomic, strong) LWDPageControl1 * pageControl;
@end
...
- (void)viewDidLoad {
    ...
    _pageControl = [[LWDPageControl1 alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame)-40, CGRectGetWidth(self.view.frame), 40) indicatorMargin:5.f indicatorWidth:10.f currentIndicatorWidth:20.f indicatorHeight:10 gearEffect:YES];
